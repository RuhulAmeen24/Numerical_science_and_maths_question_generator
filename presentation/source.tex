...
%%objective, method, expected outcome, timeline, references
...
\begin{frame}
    ...
    %  \bibitem[label1]{cite_key1} SCIMAT 
    %  \bibitem[label2]{cite_key2} DiffuSeq
    %  ...
    ...
    %references
    \bibitem{scimat} Neeraj Kollepara and Snehith Kumar Chatakonda and Pawan Kumar, "SCIMAT: Science and Mathematics Dataset".

    \bibitem{gong2022diffuseq} Gong, Shansan and Li, Mukai and Feng, Jiangtao and Wu, Zhiyong and Kong, Lingpeng, "DiffuSeq: Sequence to Sequence Text Generation with Diffusion Models".

    \bibitem{Li-2022-DiffusionLM} Xiang Lisa Li and John Thickstun and Ishaan Gulrajani and Percy Liang and Tatsunori Hashimoto, "Diffusion-LM Improves Controllable Text Generation".
